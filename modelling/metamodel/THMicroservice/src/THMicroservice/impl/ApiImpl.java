 ...
 * </p>
 * <ul>
 *   <li>{@link THMicroservice.impl.ApiImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link THMicroservice.impl.ApiImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends FunctionImpl implements Api {
	/**
	...
	protected EClass eStaticClass() {
		return THMicroservicePackage.Literals.API;
	}
	...
	public void setAnnotation(String newAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMicroservicePackage.API__ANNOTATION, oldAnnotation, annotation));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMicroservicePackage.API__PATH, oldPath, path));
	}
