 ...
 * </p>
 * <ul>
 *   <li>{@link THMicroservice.impl.ControllerImpl#getPath <em>Path</em>}</li>
 *   <li>{@link THMicroservice.impl.ControllerImpl#getInjections <em>Injections</em>}</li>
 *   <li>{@link THMicroservice.impl.ControllerImpl#getApis <em>Apis</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControllerImpl extends JavaClassImpl implements Controller {
	...
	protected EClass eStaticClass() {
		return THMicroservicePackage.Literals.CONTROLLER;
	}
	...
	public void setPath(String newPath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMicroservicePackage.CONTROLLER__PATH, oldPath, path));
	}
	...
	public EList<Repository> getInjections() {
		if (injections == null) {
			injections = new EObjectResolvingEList<Repository>(Repository.class, this, THMicroservicePackage.CONTROLLER__INJECTIONS);
		}
		return injections;
	}
	...
	public EList<Api> getApis() {
		if (apis == null) {
			apis = new EObjectContainmentEList<Api>(Api.class, this, THMicroservicePackage.CONTROLLER__APIS);
		}
		return apis;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case THMicroservicePackage.CONTROLLER__APIS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case THMicroservicePackage.CONTROLLER__PATH:
				return getPath();
			case THMicroservicePackage.CONTROLLER__INJECTIONS:
