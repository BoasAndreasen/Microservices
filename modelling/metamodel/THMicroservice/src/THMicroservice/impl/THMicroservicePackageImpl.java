...
import THMicroservice.Variable;
 ...
 * @generated
 */
public class THMicroservicePackageImpl extends EPackageImpl implements THMicroservicePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see THMicroservice.THMicroservicePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private THMicroservicePackageImpl() {
		super(eNS_URI, THMicroserviceFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link THMicroservicePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static THMicroservicePackage init() {
		if (isInited) return (THMicroservicePackage)EPackage.Registry.INSTANCE.getEPackage(THMicroservicePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTHMicroservicePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		THMicroservicePackageImpl theTHMicroservicePackage = registeredTHMicroservicePackage instanceof THMicroservicePackageImpl ? (THMicroservicePackageImpl)registeredTHMicroservicePackage : new THMicroservicePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTHMicroservicePackage.createPackageContents();

		// Initialize created meta-data
		theTHMicroservicePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTHMicroservicePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(THMicroservicePackage.eNS_URI, theTHMicroservicePackage);
		return theTHMicroservicePackage;
	}
	 ...
	 * @generated
	 */
	public THMicroserviceFactory getTHMicroserviceFactory() {
		return (THMicroserviceFactory)getEFactoryInstance();
	}
