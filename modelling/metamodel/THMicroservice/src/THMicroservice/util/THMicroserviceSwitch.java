 ...
 * @generated
 */
public class THMicroserviceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case THMicroservicePackage.DOMAIN: {
			...
			case THMicroservicePackage.DTO: {
			...
			case THMicroservicePackage.PUBLISHER: {
			...
			case THMicroservicePackage.SUBSCRIBER: {
			...
			case THMicroservicePackage.REPOSITORY: {
			...
			case THMicroservicePackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case THMicroservicePackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case THMicroservicePackage.API: {
