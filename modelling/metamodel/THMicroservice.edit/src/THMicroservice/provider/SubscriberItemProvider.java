...
/**
 * This is the item provider adapter for a {@link THMicroservice.Subscriber} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubscriberItemProvider extends JavaClassItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 THMicroservicePackage.Literals.SUBSCRIBER__GROUP_ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 THMicroservicePackage.Literals.SUBSCRIBER__INJECTIONS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(THMicroservicePackage.Literals.SUBSCRIBER__EVENT_STREAMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(THMicroservicePackage.Literals.SUBSCRIBER__EVENT_STREAMS,
				 THMicroserviceFactory.eINSTANCE.createEventStream()));
	}
