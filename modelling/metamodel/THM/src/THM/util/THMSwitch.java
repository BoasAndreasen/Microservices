 ...
 * @generated
 */
public class THMSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static THMPackage modelPackage;
	...
	public THMSwitch() {
		if (modelPackage == null) {
			modelPackage = THMPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case THMPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case THMPackage.FUNCTION: {
