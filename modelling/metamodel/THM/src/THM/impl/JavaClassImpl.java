 ...
 * </p>
 * <ul>
 *   <li>{@link THM.impl.JavaClassImpl#getClassPackage <em>Class Package</em>}</li>
 *   <li>{@link THM.impl.JavaClassImpl#getClassName <em>Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaClassImpl extends MinimalEObjectImpl.Container implements JavaClass {
	...
	protected EClass eStaticClass() {
		return THMPackage.Literals.JAVA_CLASS;
	}
	...
	public void setClassPackage(String newClassPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMPackage.JAVA_CLASS__CLASS_PACKAGE, oldClassPackage, classPackage));
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMPackage.JAVA_CLASS__CLASS_NAME, oldClassName, className));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case THMPackage.JAVA_CLASS__CLASS_PACKAGE:
				return getClassPackage();
			case THMPackage.JAVA_CLASS__CLASS_NAME:
				return getClassName();
		}
