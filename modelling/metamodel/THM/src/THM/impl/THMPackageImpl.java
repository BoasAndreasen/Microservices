 ...
 * @generated
 */
public class THMPackageImpl extends EPackageImpl implements THMPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see THM.THMPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private THMPackageImpl() {
		super(eNS_URI, THMFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link THMPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static THMPackage init() {
		if (isInited) return (THMPackage)EPackage.Registry.INSTANCE.getEPackage(THMPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTHMPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		THMPackageImpl theTHMPackage = registeredTHMPackage instanceof THMPackageImpl ? (THMPackageImpl)registeredTHMPackage : new THMPackageImpl();

		isInited = true;

		// Create package meta-data objects
		theTHMPackage.createPackageContents();

		// Initialize created meta-data
		theTHMPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theTHMPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(THMPackage.eNS_URI, theTHMPackage);
		return theTHMPackage;
	}
	 ...
	 * @generated
	 */
	public THMFactory getTHMFactory() {
		return (THMFactory)getEFactoryInstance();
	}
