 ...
 * </p>
 * <ul>
 *   <li>{@link THM.impl.ApiImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link THM.impl.ApiImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends FunctionImpl implements Api {
	...
	protected EClass eStaticClass() {
		return THMPackage.Literals.API;
	}
	...
	public void setAnnotation(String newAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMPackage.API__ANNOTATION, oldAnnotation, annotation));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, THMPackage.API__PATH, oldPath, path));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case THMPackage.API__ANNOTATION:
				return getAnnotation();
			case THMPackage.API__PATH:
				return getPath();
		}
