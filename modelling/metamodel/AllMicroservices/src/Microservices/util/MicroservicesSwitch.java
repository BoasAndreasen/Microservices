...
public class MicroservicesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MicroservicesPackage.TOP_NODE: {
				TopNode topNode = (TopNode)theEObject;
				T result = caseTopNode(topNode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.EVENT_STREAM: {
			...
			case MicroservicesPackage.JAVA_CLASS: {
				JavaClass javaClass = (JavaClass)theEObject;
				T result = caseJavaClass(javaClass);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.CONTROLLER: {
			...
			case MicroservicesPackage.DOMAIN: {
				Domain domain = (Domain)theEObject;
				T result = caseDomain(domain);
				if (result == null) result = caseJavaClass(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.DTO: {
				Dto dto = (Dto)theEObject;
				T result = caseDto(dto);
				if (result == null) result = caseJavaClass(dto);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.PUBLISHER: {
				Publisher publisher = (Publisher)theEObject;
				T result = casePublisher(publisher);
				if (result == null) result = caseJavaClass(publisher);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.SUBSCRIBER: {
				Subscriber subscriber = (Subscriber)theEObject;
				T result = caseSubscriber(subscriber);
				if (result == null) result = caseJavaClass(subscriber);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.REPOSITORY: {
				Repository repository = (Repository)theEObject;
				T result = caseRepository(repository);
				if (result == null) result = caseJavaClass(repository);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.FUNCTION: {
				Function function = (Function)theEObject;
				T result = caseFunction(function);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MicroservicesPackage.API: {
				Api api = (Api)theEObject;
				T result = caseApi(api);
				if (result == null) result = caseFunction(api);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
