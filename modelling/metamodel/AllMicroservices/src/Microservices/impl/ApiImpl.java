 ...
 * </p>
 * <ul>
 *   <li>{@link Microservices.impl.ApiImpl#getAnnotation <em>Annotation</em>}</li>
 *   <li>{@link Microservices.impl.ApiImpl#getPath <em>Path</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApiImpl extends FunctionImpl implements Api {
	...
	protected EClass eStaticClass() {
		return MicroservicesPackage.Literals.API;
	}
	...
	public void setAnnotation(String newAnnotation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.API__ANNOTATION, oldAnnotation, annotation));
	}
	...
	public void setPath(String newPath) {
		...
		path = newPath;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.API__PATH, oldPath, path));
	}
