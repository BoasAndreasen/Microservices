 ...
 * </p>
 * <ul>
 *   <li>{@link Microservices.impl.EventImpl#getName <em>Name</em>}</li>
 *   <li>{@link Microservices.impl.EventImpl#getKeyType <em>Key Type</em>}</li>
 *   <li>{@link Microservices.impl.EventImpl#getKeyName <em>Key Name</em>}</li>
 *   <li>{@link Microservices.impl.EventImpl#getValType <em>Val Type</em>}</li>
 *   <li>{@link Microservices.impl.EventImpl#getValName <em>Val Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends MinimalEObjectImpl.Container implements Event {
	...
	protected EClass eStaticClass() {
		return MicroservicesPackage.Literals.EVENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.EVENT__NAME, oldName, name));
	}
	...
	public void setKeyType(String newKeyType) {
		...
		keyType = newKeyType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.EVENT__KEY_TYPE, oldKeyType, keyType));
	}
	...
	public void setKeyName(String newKeyName) {
		...
		keyName = newKeyName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.EVENT__KEY_NAME, oldKeyName, keyName));
	}
	...
	public void setValType(String newValType) {
		...
		valType = newValType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.EVENT__VAL_TYPE, oldValType, valType));
	}
	...
	public void setValName(String newValName) {
		...
		valName = newValName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.EVENT__VAL_NAME, oldValName, valName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MicroservicesPackage.EVENT__NAME:
				return getName();
			case MicroservicesPackage.EVENT__KEY_TYPE:
				return getKeyType();
			case MicroservicesPackage.EVENT__KEY_NAME:
				return getKeyName();
			case MicroservicesPackage.EVENT__VAL_TYPE:
				return getValType();
			case MicroservicesPackage.EVENT__VAL_NAME:
				return getValName();
		}
