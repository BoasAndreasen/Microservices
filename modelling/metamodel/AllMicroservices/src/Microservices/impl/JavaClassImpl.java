 ...
 * </p>
 * <ul>
 *   <li>{@link Microservices.impl.JavaClassImpl#getClassPackage <em>Class Package</em>}</li>
 *   <li>{@link Microservices.impl.JavaClassImpl#getClassName <em>Class Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaClassImpl extends MinimalEObjectImpl.Container implements JavaClass {
	...
	protected EClass eStaticClass() {
		return MicroservicesPackage.Literals.JAVA_CLASS;
	}
	...
	public void setClassPackage(String newClassPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.JAVA_CLASS__CLASS_PACKAGE, oldClassPackage, classPackage));
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.JAVA_CLASS__CLASS_NAME, oldClassName, className));
	}
