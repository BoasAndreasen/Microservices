 ...
 * </p>
 * <ul>
 *   <li>{@link Microservices.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link Microservices.impl.FunctionImpl#getOutputType <em>Output Type</em>}</li>
 *   <li>{@link Microservices.impl.FunctionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link Microservices.impl.FunctionImpl#isBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionImpl extends MinimalEObjectImpl.Container implements Function {
	...
	protected EClass eStaticClass() {
		return MicroservicesPackage.Literals.FUNCTION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.FUNCTION__NAME, oldName, name));
	}
	...
	public void setOutputType(String newOutputType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.FUNCTION__OUTPUT_TYPE, oldOutputType, outputType));
	}
	...
	public EList<Variable> getParameters() {
		if (parameters == null) {
			parameters = new EObjectContainmentEList<Variable>(Variable.class, this, MicroservicesPackage.FUNCTION__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setBody(boolean newBody) {
		...
		body = newBody;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MicroservicesPackage.FUNCTION__BODY, oldBody, body));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MicroservicesPackage.FUNCTION__PARAMETERS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MicroservicesPackage.FUNCTION__NAME:
				return getName();
			case MicroservicesPackage.FUNCTION__OUTPUT_TYPE:
				return getOutputType();
			case MicroservicesPackage.FUNCTION__PARAMETERS:
				return getParameters();
			case MicroservicesPackage.FUNCTION__BODY:
				return isBody();
		}
