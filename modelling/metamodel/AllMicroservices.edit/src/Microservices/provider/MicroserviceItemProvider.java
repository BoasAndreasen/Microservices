...
public class MicroserviceItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MicroservicesPackage.Literals.MICROSERVICE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__SUBSCRIBERS);
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__PUBLISHERS);
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__CONTROLLERS);
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__DOMAINS);
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__DTOS);
			childrenFeatures.add(MicroservicesPackage.Literals.MICROSERVICE__REPOSITORIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__SUBSCRIBERS,
				 MicroservicesFactory.eINSTANCE.createSubscriber()));

		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__PUBLISHERS,
				 MicroservicesFactory.eINSTANCE.createPublisher()));

		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__CONTROLLERS,
				 MicroservicesFactory.eINSTANCE.createController()));

		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__DOMAINS,
				 MicroservicesFactory.eINSTANCE.createDomain()));

		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__DTOS,
				 MicroservicesFactory.eINSTANCE.createDto()));

		newChildDescriptors.add
			(createChildParameter
				(MicroservicesPackage.Literals.MICROSERVICE__REPOSITORIES,
				 MicroservicesFactory.eINSTANCE.createRepository()));
	}
