...
@Client("${users.url:`http://localhost:8082/subscriptionHashtags`}")
public interface HashtagsClient {
	...
	public Iterable<User> getSubscribers(String name);
	...
	public HttpResponse<String> deleteSubscriber(String name, String username);
